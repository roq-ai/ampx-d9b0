            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('emergency', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/emergencies/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Emergency Type" text={data?.emergency_type} />
                ...
                {hasAccess('service_request', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/service-requests/view/${data?.service_request?.id}`}>
                        {data?.service_request?.service_type}
                      </Link>
                    }
                  />
                )}
