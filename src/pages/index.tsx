  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="AMPX - Empowering EV car & bike owners with on-demand charging services, medical emergencies and towing, right at your location, when you need it the most."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`AMPX - Empowering EV car & bike owners with on-demand charging services, medical emergencies and towing, right at your location, when you need it the most.`}
            </Text>
            <Box
