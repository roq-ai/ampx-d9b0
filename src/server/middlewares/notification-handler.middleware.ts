...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'service_request_create.create': {
    roles: ['service-technician', 'business-owner'],
    key: 'service_request',
    tenantPath: [],
    userPath: [],
  },
  'service_update.update': { roles: ['service-technician'], key: 'service_request', tenantPath: [], userPath: [] },
  'service_completion.update': { roles: ['business-owner'], key: 'service_request', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['business-owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['service-technician'];
